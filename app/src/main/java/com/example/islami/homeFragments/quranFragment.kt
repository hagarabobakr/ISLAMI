package com.example.islami.homeFragments
...
class quranFragment : Fragment() {
    ...
    val suraNames = listOf<String>("الفاتحه",
        "البقرة",
        "آل عمران",
        "النساء",
        "المائدة",
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        rec = view.findViewById(R.id.suraNameRecyclerView)
        adapter = SuraNameAdapter(suraNames)
        rec.adapter = adapter
        adapter.on_item_click = object : SuraNameAdapter.onItemClick {
